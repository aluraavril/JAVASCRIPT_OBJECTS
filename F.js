// Use the same array and demonstrate a sample code using the map() method on the array.
...
const cafeNames = cafes.map(cafe => cafe.name);
console.log("Cafe names:", cafeNames);
