// Use the same array and demonstrate a sample code using the push() method on the array.
...
cafes.push({ name: "Coffee Project", location: "Alabang", rating: 4.9 });
console.log("Push Result:", cafes);
